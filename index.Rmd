...
<sup>* See [Employment History] on next page for more details</sup>
...
Th FT's Data Science team is responsible for
...
*  As part of our product strategy I undertook a project to attribute value
   ...
   monetary value and engagement each part of our digital real-estate was 
   generating.
...
<i class="fab fa-r-project"></i> Programming Skills {data-icon=blank .break-after-me} 
-------------------------------------------------------------------------------- 

### R

I've been using R for many years now and so I think it's worth providing some 
more detail on the skills I have gained.
